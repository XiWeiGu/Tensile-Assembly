...
.text
.protected Cijk_Ailk_Bljk_SB_MT32x32x8_SN_EPS1_K1_LPB4_LRVW4_PGR1_PLR1_SVW1_TT4_4_VW4_VWB4_WG8_8_4_WGM1
.globl Cijk_Ailk_Bljk_SB_MT32x32x8_SN_EPS1_K1_LPB4_LRVW4_PGR1_PLR1_SVW1_TT4_4_VW4_VWB4_WG8_8_4_WGM1
.p2align 8
.type Cijk_Ailk_Bljk_SB_MT32x32x8_SN_EPS1_K1_LPB4_LRVW4_PGR1_PLR1_SVW1_TT4_4_VW4_VWB4_WG8_8_4_WGM1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bljk_SB_MT32x32x8_SN_EPS1_K1_LPB4_LRVW4_PGR1_PLR1_SVW1_TT4_4_VW4_VWB4_WG8_8_4_WGM1
...
amdhsa.kernels:
  - .name: Cijk_Ailk_Bljk_SB_MT32x32x8_SN_EPS1_K1_LPB4_LRVW4_PGR1_PLR1_SVW1_TT4_4_VW4_VWB4_WG8_8_4_WGM1
    .symbol: 'Cijk_Ailk_Bljk_SB_MT32x32x8_SN_EPS1_K1_LPB4_LRVW4_PGR1_PLR1_SVW1_TT4_4_VW4_VWB4_WG8_8_4_WGM1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bljk_SB_MT32x32x8_SN_EPS1_K1_LPB4_LRVW4_PGR1_PLR1_SVW1_TT4_4_VW4_VWB4_WG8_8_4_WGM1:
...
Cijk_Ailk_Bljk_SB_MT32x32x8_SN_EPS1_K1_LPB4_LRVW4_PGR1_PLR1_SVW1_TT4_4_VW4_VWB4_WG8_8_4_WGM1_preloaded: // Kernel start when preloading
...
/* local read a */
_ds_load_b128 v[vgprValuA_X1_I0+0:vgprValuA_X1_I0+0+3], v[vgprLocalReadAddrA] offset:512 // L -> Reg lro=128 swapByteOffset=0 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
_buffer_load_b32 v[vgprG2LA+0], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], 0, offen offset:0 // G -> Reg 0_0_0_0
_buffer_load_b32 v[vgprG2LB+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0, offen offset:0 // G -> Reg 0_0_0_0
...
/* local read b */
_ds_load_b128 v[vgprValuB_X1_I0+0:vgprValuB_X1_I0+0+3], v[vgprLocalReadAddrB] offset:576 // L -> Reg lro=144 swapByteOffset=0 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
...
/* localReadInitPointers */
s_waitcnt lgkmcnt(4)                               // lgkmcnt=0 vmcnt=-1wait for prior local read local write old=0, new=4 newLW=0 newLR=0
MAC_4x4_X0
...
/* local read a */
_ds_load_b128 v[vgprValuA_X0_I0+0:vgprValuA_X0_I0+0+3], v[vgprLocalReadAddrA] offset:4096 // L -> Reg lro=0 swapByteOffset=4096 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0

/* local read b */
_ds_load_b128 v[vgprValuB_X0_I0+0:vgprValuB_X0_I0+0+3], v[vgprLocalReadAddrB] offset:4096 // L -> Reg lro=0 swapByteOffset=4096 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
...
/* local read a */
_ds_load_b128 v[vgprValuA_X1_I0+0:vgprValuA_X1_I0+0+3], v[vgprLocalReadAddrA] offset:4608 // L -> Reg lro=128 swapByteOffset=4096 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
_buffer_load_b32 v[vgprG2LA+0], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], 0, offen offset:0 // G -> Reg 0_0_0_0
_buffer_load_b32 v[vgprG2LB+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0, offen offset:0 // G -> Reg 0_0_0_0
...
/* local read b */
_ds_load_b128 v[vgprValuB_X1_I0+0:vgprValuB_X1_I0+0+3], v[vgprLocalReadAddrB] offset:4672 // L -> Reg lro=144 swapByteOffset=4096 ti=8 vIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(1)                                 // lgkmcnt=-1 vmcnt=1wait for global read before writing to local
_ds_store_b32 v[vgprLocalWriteAddrA], v[vgprG2LA+0] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
/* sched write - iter 0 writesPerItem=1 */
...
v_lshrrev_b32 v47, 6, v[vgprSerial]                // v47 = v[vgprSerial] / 64
v_mov_b32 v46, s[sgprSizesSum+0]                   // sizeU to vgpr
v_and_b32 v48, 7, v46                              // v48 = v46 % 8
TailLoopBeginL_6:
_v_cmpx_lt_u32 vcc, v47, v48                       // sgId < numIter
_v_add_co_u32 v47, vcc, 0x4, v47                   // sgId+=LSU
...
s_mov_b32 s53, 0x240                               // inc
_v_add_co_u32 v[vgprLocalReadAddrB], vcc, s53, v[vgprLocalReadAddrB] // lrB += 576 (LSU*(MT+PAD)*bpe)
...
s_mov_b64 s[54:55], 0xFFFFFFFFFFFFFFFF             // restore all threads active
s_or_saveexec_b64 s[54:55], s[54:55]               // full mask -> exec
...
s_cbranch_scc0 GW_Beta_32                          // Branch if Beta is not zero
