...
.text
.protected Cij_Aik_Bkj_S_MT64x64x4_SN_K1_SVW1_WGM4
.globl Cij_Aik_Bkj_S_MT64x64x4_SN_K1_SVW1_WGM4
.p2align 8
.type Cij_Aik_Bkj_S_MT64x64x4_SN_K1_SVW1_WGM4,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cij_Aik_Bkj_S_MT64x64x4_SN_K1_SVW1_WGM4
...
amdhsa.kernels:
  - .name: Cij_Aik_Bkj_S_MT64x64x4_SN_K1_SVW1_WGM4
    .symbol: 'Cij_Aik_Bkj_S_MT64x64x4_SN_K1_SVW1_WGM4.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cij_Aik_Bkj_S_MT64x64x4_SN_K1_SVW1_WGM4:
...
Cij_Aik_Bkj_S_MT64x64x4_SN_K1_SVW1_WGM4_preloaded: // Kernel start when preloading
...
s_mov_b32 s59, 0x20000001L                         // magic number for WGM==4
s_mul_hi_u32 s57, s[sgprWorkGroup1], s59           // s_magic mul
s_mul_i32 s56, s[sgprWorkGroup1], s59              // s_magic mul
s_lshr_b64 s[56:57], s[56:57], 31                  // sMagicDiv
s_mul_i32 s57, s56, 4                              // quotient * non-magic divisor
s_sub_u32 s57, s[sgprWorkGroup1], s57              // WorkGroup1=remainder
s_mul_i32 s57, s57, s[sgprNumWorkGroups0]          // (wg1 % WGM)*nwg0
s_add_u32 s57, s57, s[sgprWorkGroup0]              // wgSerial = wg0 + (wg1 % WGM)*nwg1
s_cmp_ge_u32 s56, s[sgprNumFullBlocks]             // blockId >= numFullBlocks ?
s_cmov_b32 s59, s[sgprMagicNumberWgmRemainder1]    // 
s_cselect_b32 s58, s[sgprWgmRemainder1], 4         // 
s_mul_hi_u32 s3, s57, s59                          // s_magic mul
s_mul_i32 s2, s57, s59                             // s_magic mul
s_lshr_b64 s[2:3], s[2:3], 31                      // sMagicDiv
s_mul_i32 s[sgprWorkGroup1], s[sgprWorkGroup0], s58 // quotient * non-magic divisor
s_sub_u32 s[sgprWorkGroup1], s57, s[sgprWorkGroup1] // WorkGroup1=remainder
s_mul_i32 s56, s56, 4                              // blockId * WGM
...
s_mov_b32 s58, 2                                   // 
s_mul_hi_u32 s57, s58, s[sgprGlobalReadIncsA+0]    // 2 * GlobalReadIncs
s_mul_i32 s56, s58, s[sgprGlobalReadIncsA+0]       // 2 * GlobalReadIncs
...
s_mov_b32 s58, 2                                   // 
s_mul_hi_u32 s57, s58, s[sgprGlobalReadIncsB+0]    // 2 * GlobalReadIncs
s_mul_i32 s56, s58, s[sgprGlobalReadIncsB+0]       // 2 * GlobalReadIncs
